...
import {
  fetchStatus, fetchMetrics, fetchShadow, fetchShadowPredictions,
...
export const useShadowPredictions  = () => useQuery({ queryKey: ['shadowPredictions'],  queryFn: fetchShadowPredictions,  retry: 3, staleTime: 60000  })
